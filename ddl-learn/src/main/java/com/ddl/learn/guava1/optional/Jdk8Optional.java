package com.ddl.learn.guava1.optional;

import com.ddl.learn.guava1.entity.Godness;
import com.ddl.learn.guava1.entity.Man;
...
public class Jdk8Optional {
    public static void main(String[] args) {
        ...
        //如果有值orElse方法会返回Optional实例，否则返回传入的自定义信息
        ...
        try {
            ...
            System.out.println("异常信息2" + ex.getMessage());
        }
