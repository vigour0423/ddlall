package com.ddl.learn.kafka.oldapi;


import java.util.Properties;

import com.ddl.learn.kafka.oldapi.HashPartitioner;
...
public class ProducerDemo {
    ...
    static private final String ZOOKEEPER = "hadoop1:2181,hadoop3:2181,hadoop2:2181";

    static private final String BROKER_LIST = "hadoop1:9092";
    ...
    public static void sendOne(Producer<String, String> producer, String topic) throws InterruptedException {
        ...
        //Thread.sleep(5000);
        KeyedMessage<String, String> message3 = new KeyedMessage<String, String>(topic, "32", "test 33");
