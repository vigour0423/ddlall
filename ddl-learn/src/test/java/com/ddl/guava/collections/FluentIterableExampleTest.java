...
public class FluentIterableExampleTest {
    ...
    private FluentIterable<String> build() {
        ArrayList<String> list = Lists.newArrayList("Python", "Java", "Guava", "Scala");
    ...
    public void testAppend() {
        ...
        assertThat(appendFI.contains("Python"), is(true));
    }
    ...
    public void testCopyIn() {
        ...
        assertThat(result.contains("Go"), is(true));
    }
    ...
    public void testTransformAndConcat() {
        ...
        FluentIterable<Integer> result = fit.transformAndConcat(e -> {
    ...
    public void testJoin() {
        ...
        assertThat(result, equalTo("Python, Java, Guava, Scala"));
    }
    ...
    private List<Customer> search(int type) {
        if (type == 1) {
            return Lists.newArrayList(
                    new Customer(type, "Kevin"),
                    new Customer(type, "Tina")
            );
        } else {
            return Lists.newArrayList(
                    new Customer(type, "Jack"),
                    new Customer(type, "David"),
                    new Customer(type, "Jun"));
        }
    }
