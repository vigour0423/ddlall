...
public class ListsExampleTest {
    ...
    public void testTransform() {
        ...
        Lists.transform(sourceList, String::toUpperCase)
                .forEach(System.out::println);

        Lists.charactersOf("dbdf").forEach(System.out::println);
    ...
    public void testNewArrayListWithExpectedSize() {
        ArrayList<Object> objects = Lists.newArrayListWithExpectedSize(5);
