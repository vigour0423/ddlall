...
public class MyTest2 {
    public static void main(String[] args) throws Exception {
        ...
        Class<?> class1 = classLoader1.loadClass("com.ddl.learn.jvm.classloader.namespace_runpack.MyPerson");
        Class<?> class2 = classLoader2.loadClass("com.ddl.learn.jvm.classloader.namespace_runpack.MyPerson");
